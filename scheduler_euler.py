...
@dataclass
class EulerSchedulerOutput(BaseOutput):
    """
...
class EulerScheduler(SchedulerMixin, ConfigMixin):
    """
    ...
    def step(
    ...
    ) -> Union[EulerSchedulerOutput, Tuple]:
        ...
        return EulerSchedulerOutput(prev_sample=prev_x)
